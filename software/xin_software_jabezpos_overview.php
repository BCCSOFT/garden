...
<?php include("../asset/head/software/xin_head_software_jabezpos_overview.php"); ?>
...
<body id="page-jabezpos" class="gx xin body">
    ...
    <!-- SUB-MWNU -->
	<?php include("xin_nav_id=jabezpos.php"); ?>
    ...
    <main>
      ...
      <article>
		  ...
		  <?php include("xin_software_jabezpos_id=overview.php"); ?>
