...
<?php include("../asset/head/hardware/xin_head_hardware_t1.php"); ?>
...
<!--<link rel="stylesheet" type="text/css" href="../asset/style/hardware.css">-->
<?php include("../asset/head/_all/xin_all_script.php"); ?>

<body id="hardware_t1" class="gx xin">
    ...
    <main>
      ...
      <!-- ARTICLE -->
      <article>
		  <?php include("xin_hardware_id=t1.php"); ?>
      </article>
      <!-- ASIDE -->
      <aside></aside>
