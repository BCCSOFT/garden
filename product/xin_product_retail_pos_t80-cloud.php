...
<?php include("../asset/head/product/xin_head_product_retail_pos_t80-cloud.php"); ?>
...
<body id="retail_pos_t80-cloud" class="gx xin retail-solution">
            ...
            <nav class="product-nav-img">
              <article>
                <ol>
                  ...
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
                    <a href="xin_product_retail_pos_t80-cloud.php" data-type="button" class="active"></a>
                  </li>
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
        ...
        <nav class="product-nav counter-nav">
          <article>
            <ol>
              ...
              <li>
                <a href="xin_product_retail_pos_t80-cloud.php" data-type="button" class="active">雲端專業版</a>
              </li>
              <li>
