...
<?php include("../asset/head/product/xin_head_product_retail_mobile-pos_x990.php"); ?>
...
<body id="retail_mobile-pos_x990" class="gx xin retail-solution">
            ...
            <nav class="product-nav-img">
              <article>
                <ol>
                  ...
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
                    <a href="xin_product_retail_mobile-pos_x990.php" data-type="button" class="active"></a>
                  </li>
                </ol>
              </article>
            </nav>
        ...
        <nav class="product-nav mobile-pos-nav">
		  <article>
			<ol>
			  ...
			  <li>
				<a href="xin_product_retail_mobile-pos_x990.php" data-type="button" class="active">進階感應版</a>
			  </li>
			</ol>
		  </article>
		</nav>
