...
<?php include("../asset/head/product/xin_head_product_restaurant_pos_t1.php"); ?>
...
<?php include("../asset/head/_all/xin_all_script.php"); ?>
 ...
 <body id="restaurant_pos_t1" class="gx xin">
      ...
      <article>
            ...
            <nav class="product-nav-img">
              <article>
                <ol>
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
                    <a href="xin_product_restaurant_pos_t1.php" data-type="button" class="active"></a>
                  </li>
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
        ...
        <nav class="product-nav counter-nav">
		  <article>
			<ol>
			  <li>
				<a href="xin_product_restaurant_pos_t1.php" data-type="button" class="active">雲端基本版</a>
			  </li>
			  <li>
