...
<?php include("../asset/head/product/xin_head_product_retail_pos_t1.php"); ?>
...
<body id="retail_pos_t1 overview" class="gx xin retail-solution">
      ...
      <article>
            ...
            <nav class="product-nav-img">
              <article>
                <ol>
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
                    <a href="xin_product_retail_pos_t1.php" data-type="button" class="active"></a>
                  </li>
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
       ...
       <nav class="product-nav counter-nav">
          <article>
            <ol>
              <li>
                <a href="xin_product_retail_pos_t1.php" data-type="button" class="active">雲端基本版</a>
              </li>
              <li>
        ...
        <article>
          ...
          <section data-tab-content="?id=overview" class="active">
			<?php include("xin_product_pos_t1_id=overview.php"); ?>
		  </section>

          <!-- 軟體介紹 -->
          <section data-tab-content="?id=software" data-standby-html="../software/xin_software_id=bpos.php">
			<?php include("../software/xin_software_id=bpos.php"); ?>
		  </section>

          <!-- 硬體介紹 -->
          <section data-tab-content="?id=hardware" data-standby-html="../hardware/xin_hardware_id=t1.php">
			<?php include("../hardware/xin_hardware_id=t1.php"); ?>	
		  </section>
