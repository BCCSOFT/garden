...
<?php include("../asset/head/product/xin_head_product_retail_multi-store_overview.php"); ?>
    ...
    <nav id="main-nav" class="effect_fixed">
      <article>
        ...
        <ol data-toggle-content="product-nav">
          <li><a href="../product/xin_product_retail_multi-store_overview.php" class="active">概觀介紹</a></li>
          <li><a href="../product/xin_product_retail_multi-store_hardware.php">硬體規格</a></li>
        </ol>
      </article>
    </nav>
