...
<?php include("../asset/head/product/xin_head_product_restaurant_pos_t80.php"); ?>
...
<?php include("../asset/head/_all/xin_all_script.php"); ?>
 ...
 <body id="gx restaurant_pos_t80 overview" class="xin">
            ...
            <nav class="product-nav-img">
              <article>
                <ol>
                  ...
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
                    <a href="xin_product_restaurant_pos_t80.php" data-type="button" class="active"></a>
                  </li>
                </ol>
              </article>
            </nav>
        ...
        <nav class="product-nav counter-nav">
		  <article>
			<ol>
			  ...
			  <li>
				<a href="xin_product_restaurant_pos_t80.php" data-type="button" class="active">單機專業版</a>
			  </li>
			</ol>
		  </article>
		</nav>
