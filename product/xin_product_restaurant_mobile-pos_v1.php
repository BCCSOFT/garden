      ...
      <article>
            ...
            <nav class="product-nav-img">
              <article>
                <ol>
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
                    <a href="xin_product_restaurant_mobile-pos_v1.php" data-type="button" class="active"></a>
                  </li>
                  <li>
                    <span><img alt="" src="../asset/image/img.png"></span>
		...
		<nav class="product-nav mobile-pos-nav">
		  <article>
			<ol>
			  <li>
				<a href="xin_product_restaurant_mobile-pos_v1.php" data-type="button" class="active">簡易掃碼版</a>
			  </li>
			  <li>
